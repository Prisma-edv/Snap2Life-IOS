...
#define POPUP_MAXIMUM_SIZE CGSizeMake(280, 140)
...
- (id)initAtPoint:(CGPoint)point delegate:(id<ADPopupViewDelegate>)theDelegate withMessage:(NSString *)theMessage {
    ...
    if (self = [super initWithFrame:CGRectZero]) {
        ...
        self.messageLabelFont = [UIFont boldSystemFontOfSize:12.f];
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.type) {
        case ptDownLeft: {
            ...
            mrect = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height - POPUP_ARROW_SIZE.height) cornerRadius:POPUP_CORNER_RADIUS];
            [mrect fill];
        ...
        case ptUpLeft: {
            ...
            mrect = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, POPUP_ARROW_SIZE.height, self.frame.size.width, self.frame.size.height - POPUP_ARROW_SIZE.height) cornerRadius:POPUP_CORNER_RADIUS];
            [mrect fill];
